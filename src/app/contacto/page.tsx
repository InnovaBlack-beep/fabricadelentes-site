...
export default function Contacto() {
  return (
    <>
      {/* Hero */}
      <section className="pt-14 pb-8 md:pt-20 md:pb-12 bg-[#f7f7f7]">
        <div className="max-w-[1280px] mx-auto px-8">
          <h1 className="font-[family-name:var(--font-playfair)] text-3xl md:text-4xl uppercase tracking-[0.15em] text-[#1a1a1a] font-normal mb-3">
            Contacto
          </h1>
          <p className="text-[#666] text-[15px] max-w-xl">
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="grid md:grid-cols-3 gap-5 mb-14">
            ...
            <a
              ...
              className="group bg-white p-7 border border-[#e5e5e5] hover:border-[#25d366]/40 transition-all text-center"
            >
              <div className="w-14 h-14 bg-[#25d366]/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-[#666] text-[13px] mb-2">Respuesta en minutos</p>
            ...
            {/* Visit */}
            <div className="bg-white p-7 border border-[#e5e5e5] text-center">
              <div className="w-14 h-14 bg-[#f7f7f7] flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-[#666] text-[13px] mb-2">Guadalajara, Jalisco, México</p>
              <span className="text-[#1a1a1a] font-semibold text-[13px]">Lun - Sáb: 10:00 - 19:00</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            {/* Form */}
            <div className="bg-[#f7f7f7] p-8 border border-[#e5e5e5]">
              <h2 className="font-[family-name:var(--font-playfair)] text-xl uppercase tracking-[0.1em] text-[#1a1a1a] font-normal mb-6">
                Envíanos un Mensaje
              </h2>
              <form
              ...
              >
                <div>
                  <label htmlFor="name" className="block text-[12px] font-medium text-[#1a1a1a] mb-1.5 uppercase tracking-[0.05em]">
                    Nombre
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="phone" className="block text-[12px] font-medium text-[#1a1a1a] mb-1.5 uppercase tracking-[0.05em]">
                    Teléfono
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="service" className="block text-[12px] font-medium text-[#1a1a1a] mb-1.5 uppercase tracking-[0.05em]">
                    Qué necesitas?
                  </label>
                  <select
                    id="service"
                ...
                <div>
                  <label htmlFor="message" className="block text-[12px] font-medium text-[#1a1a1a] mb-1.5 uppercase tracking-[0.05em]">
                    Mensaje
                  </label>
                  <textarea
                    id="message"
            ...
            <div className="space-y-5">
              <div className="bg-[#f7f7f7] p-7 border border-[#e5e5e5]">
                <h3 className="text-[14px] font-semibold text-[#1a1a1a] uppercase tracking-[0.05em] mb-4">
                  Horario de Atención
                </h3>
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={h.day}
                      className="flex items-center justify-between py-2.5 border-b border-[#e5e5e5] last:border-0"
                    >
                      <span className="text-[#1a1a1a] font-medium text-[13px]">{h.day}</span>
                      <span className="text-[#666] text-[13px]">{h.hours}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-[#f7f7f7] p-7 border border-[#e5e5e5]">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-[#1a1a1a] text-[13px]">Instagram</p>
                      <p className="text-[11px] text-[#666]">@fabricadelentesmex</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-[#1a1a1a] text-[13px]">TikTok</p>
                      <p className="text-[11px] text-[#666]">@fabricadelentes</p>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="bg-[#f7f7f7] p-7 border border-[#e5e5e5]">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="border-b border-[#e5e5e5] last:border-0 pb-3 last:pb-0">
                      <p className="text-[13px] text-[#333] leading-relaxed mb-1">
                        &ldquo;{t.text}&rdquo;
                      </p>
                      <p className="text-[11px] font-semibold text-[#666] tracking-wide uppercase">{t.name}</p>
                    </div>
                  ))}
                </div>
              </div>

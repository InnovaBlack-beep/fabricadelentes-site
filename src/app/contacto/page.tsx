        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-5 mb-16">
            ...
            <a
              ...
              className="group bg-off-white rounded-2xl p-8 border border-border hover:border-green-500/30 transition-all duration-300 text-center hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="w-16 h-16 rounded-full bg-green-500/10 flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform">
            ...
            <a
              ...
              className="group bg-off-white rounded-2xl p-8 border border-border hover:border-gold/30 transition-all duration-300 text-center hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform">
            ...
            {/* Visit */}
            <div className="bg-off-white rounded-2xl p-8 border border-border text-center">
              <div className="w-16 h-16 rounded-full bg-navy/5 flex items-center justify-center mx-auto mb-5">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7 text-navy">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Form */}
            <div className="bg-off-white rounded-2xl p-8 md:p-10 border border-border">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full px-4 py-3.5 rounded-xl border border-border bg-white text-foreground placeholder:text-muted/50 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30 transition-colors"
                ...
                <div>
                  ...
                  <select
                    id="service"
                    name="service"
                    className="w-full px-4 py-3.5 rounded-xl border border-border bg-white text-foreground focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="w-full px-4 py-3.5 rounded-xl border border-border bg-white text-foreground placeholder:text-muted/50 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30 transition-colors resize-none"
                    placeholder="Cuentanos como podemos ayudarte..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full px-6 py-4 bg-foreground text-white font-semibold rounded-xl hover:bg-navy transition-colors duration-200"
                >
                  Enviar mensaje
                </button>
              </form>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gold/5 rounded-2xl p-8 border border-gold/20">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-foreground text-white text-sm font-semibold rounded-full hover:bg-navy transition-colors"
                >
                  Abrir WhatsApp

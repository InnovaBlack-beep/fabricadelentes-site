        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-10">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-[#FFFFFF] rounded-[10px] p-8 md:p-10">
              <h2
                className="text-2xl md:text-3xl text-[#111110] mb-6 font-semibold"
              >
                Agenda tu examen
              </h2>
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3.5 border border-[#E5E5E5] rounded-[10px] bg-[#FFFFFF] text-[#111110] text-sm placeholder:text-[#A09080] focus:outline-none focus:border-[#111110] transition-colors"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-5 py-3.5 border border-[#E5E5E5] rounded-[10px] bg-[#FFFFFF] text-[#111110] text-sm focus:outline-none focus:border-[#111110] transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-3.5 border border-[#E5E5E5] rounded-[10px] bg-[#FFFFFF] text-[#111110] text-sm placeholder:text-[#A09080] focus:outline-none focus:border-[#111110] transition-colors resize-none"
            ...
            <div className="space-y-6">
              {/* Address & contact */}
              <div className="bg-[#FFFFFF] rounded-[10px] p-7">
                <h3
